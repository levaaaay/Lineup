  ...
  export default {
    ...
    methods: {
      ...
      async insertLimit() {
        ...
        // const { data, error } = await supabase.from("queue_schedules").insert({
        //   limit: this.licenseLimit,
        //   service_name: "Driver's Licensing",
        // });

        // if (error) {
        //   console.error("Error inserting queue limit:", error);
        //   return;
        // }

        // console.log("Queue limit inserted successfully:", data);
