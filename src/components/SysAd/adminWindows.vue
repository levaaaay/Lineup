    ...
    <div class="windows">
        ...
        <div class="container">
            ...
            <div class="windowBoxes">
                <div class="windowBox" v-for="(item, index) in accountCount" :key="index">
                    <p>{{ index + 1 }}</p>
                    <p>{{ item.staff }}</p>
                    <div class="statusBox">
            ...
            <div class="boxHeader" @click="addWindow">
                <div class="boxHeaderTexts">
                    <p id="newAccText">+ Add New Account</p>
                </div>
            </div>
            ...
            <div v-if="editWindow" class="modal-box" style="padding: 0">
                <div style="display: flex; flex-direction: column">
                    ...
                    <div class="modalBody" style="padding: 1rem;">
                        ...
                        <button class="delete-button" @click="deleteWindow">Delete Window</button>
                    </div>
                    <div style="height: 1px; width: 100%; background-color: #ced4da"></div>
              ...
              ">
                        ...
                        <button type="button" class="btn btn-primary specbtn"
                            style="border: none; background-color: #031633" @click="saveChanges(editingIndex)">
                            confirm
                        </button>
                    </div>
                </div>
