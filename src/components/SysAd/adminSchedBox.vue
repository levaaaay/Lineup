              ...
              <div class="row g-0">
                <div class="col-md-6">
                  <div class="dateCardContent">
                    ...
                    <button class="btn btn-primary specbtn" @click="toggleDisable(day)" style="
                          background-color: #052c65;
                          border: none;
                          width: 8.625rem;
                          height: 3.125rem;
                        ">
                      {{ day.disabled ? 'Enable Day' : 'Disable Day' }}
                    </button>
                  </div>
                ...
                <div class="col-md-5">
                  <div class="card-body">
                    <button class="btn btn-primary specServ" @click="showQueueModal(day)" :disabled="day.disabled">
                      <span>Licensing</span>
      ...
      <div v-if="showModal" class="modal-box" style="padding: 0">
        <div style="display: flex; flex-direction: column">
          ...
          <div class="modalFooter" style="
            ...
            <button type="button" class="btn btn-primary specbtn" style="border: none" @click="closeModal">
              Apply
            </button>
          </div>
        </div>
