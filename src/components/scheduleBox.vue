              ...
              <div class="col-md-5">
                <div class="card-body">
                  ...
                  <button class="btn btn-primary specServ" :class="{
                    ...
                    <span class="counter" :class="queueNumberColor(
                      day.registration,
...
export default {
  ...
  created() {
    this.getQueueDetails().then(() => {
      ...
      while (count < 7) {  // Ensure we get 7 valid days excluding Sundays
        ...
        if (date.getDay() !== 0) {
          ...
          days.push({
            ...
            formattedQueueDate,
            date,
            license: this.DriverLicense[count],
            registration: this.VehicleRegistration[count],
            LETAS: this.LawEnforcement[count],
            selectedService: null,
            licenseLimit: this.DriverLicenseLimit[count] || 100,
            registrationLimit: this.VehicleRegistrationLimit[count] || 100,
            LETASLimit: this.LawEnforcementLimit[count] || 100,
            disabled: this.disabledDates[count] || false,
          });
