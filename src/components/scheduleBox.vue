  ...
  <div class="scheduleBox">
            ...
            <div class="row g-0">
              <div class="col-md-6">
                <div class="dateCardContent" :class="{ 'disabled-card': !selectedServiceType }">
                  ...
                  <button class="btn btn-primary specbtn" :disabled="!day.selectedService" @click="showQueueModal(day)"
                    style="
              ...
              <div class="col-md-5">
                <div class="card-body">
                  <button class="btn btn-primary specServ" :class="{
                    ...
                    <span>Licensing</span>
                    <span class="counter" :class="queueNumberColor(day.license, day.licenseLimit)">
                  ...
                  <button class="btn btn-primary specServ" :class="{
                    ...
                    <span class="counter" :class="queueNumberColor(day.registration, day.registrationLimit)">
      ...
      <div style="display: flex; flex-direction: column">
        ...
        <div class="modalBody" style="padding: 1rem">
          <div class="list-group">
            <div v-for="service in specificServices[selectedServiceType]" :key="service.name" class="button-container">
              <button type="button"
                class="list-group-item list-group-item-action d-flex justify-content-between align-items-center"
                :class="{ active: selectedSpecificService === service.name }"
                @click="selectSpecificService(service.name)" style="margin-top: 0;">
                {{ service.name }}
              </button>
    ...
    <div v-if="showTicketModal" class="modal-box" style="padding: 0; margin: 0;">
      <div style="display: flex; flex-direction: column">
        ...
        <div style="height: 1px; width: 100%; background-color: #ced4da"></div>
        <div class="modalBody" style="padding: 1rem">
          <span>You have successfully queued your ticket. View your ticket with the
            button below.</span>
        </div>
        <div style="height: 1px; width: 100%; background-color: #ced4da"></div>
        <div class="modalFooter" style="
          ...
          <button type="button" class="btn btn-primary specbtn" style="border: none" @click="ticketRoute">
            View Ticket
          </button>
        </div>
      </div>
    ...
    return {
      ...
      specificServices: {
        license: [
          ...
          { name: 'New Driver License (Non-Professional)', details: 'Details about New Driver License'},
          { name: 'Conductor License', details: 'Details about Conductor License' },
        ],
        registration: [
          { name: 'Sales Reporting and Registration of Motor Vehicles', details: 'Details about Sales Reporting'},
          { name: 'Vehicle Encoding/Linking', details: 'Details about Vehicle Encoding'},
          { name: 'Renewal of Motor Vehicle Registration', details: 'Details about Renewal'},
        ],
        LETAS: [
          { name: 'Settlement of Apprehension Cases', details: 'Details about Settlement'},
          { name: 'LETAS Fines and Penalties', details: 'Details about LETAS Fines'},
          { name: 'Encoding of Alarm on Driver License and Motor Vehicles', details: 'Details about Encoding of Alarm'},
        ],
      },
      email: null,
      code: Array(6).fill(""),
