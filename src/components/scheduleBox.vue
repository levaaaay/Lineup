          ...
          <div class="list-group">
            <div v-if="selectedServiceType === 'license'">
              <button
                ...
                aria-current="true"
                :class="{
                  active: selectedSpecificService === 'Student Permit',
                }"
                @click="selectSpecificService('Student Permit')"
                style="margin-top: 0"
              >
                Student's Permit
              ...
              <button
                ...
                :class="{
                  active:
                    ...
                    'New Driver License (Non-Professional)',
                }"
                @click="
                  selectSpecificService('New Driver License (Non-Professional)')
                "
                style="margin-top: 0"
              >
              ...
              <button
                ...
                class="list-group-item list-group-item-action d-flex justify-content-between align-items-center"
                :class="{
                  active: selectedSpecificService === 'Conductor License',
                }"
                @click="selectSpecificService('Conductor License')"
                style="margin-top: 0"
              >
                Conductor’s License
                <span class="badge bg-primary rounded-pill">14</span>
            ...
            <div v-if="selectedServiceType === 'registration'">
              ...
              <button
                ...
                :class="{
                  active:
                    selectedSpecificService === 'Vehicle Encoding/Linking',
                }"
            ...
            <div v-if="selectedServiceType === 'LETAS'">
              <button
                ...
                @click="
                  selectSpecificService('Settlement of Apprehension Cases')
                "
                style="margin-top: 0"
              >
                Settlement of Apprehension Cases
              ...
              <button
                ...
                :class="{
                  active:
                    selectedSpecificService === 'LETAS Fines and Penalties',
                }"
                @click="selectSpecificService('LETAS Fines and Penalties')"
                style="margin-top: 0"
              >
              ...
              <button
                ...
                style="margin-top: 0"
              >
                Encoding of Alarm on Driver's License and Motor Vehicles in
                Relation to Orders Issued by Competent Courts or Quasi-Judicial
                Bodies
                <span class="badge bg-primary rounded-pill">14</span>
              </button>
            </div>
