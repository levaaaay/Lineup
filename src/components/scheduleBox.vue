            ...
            <div class="row g-0">
              ...
              <div class="col-md-5">
                <div class="card-body">
                  ...
                  }" :disabled="day.registration >= 100" @click="selectService('registration', index)">
      ...
      <div style="display: flex; flex-direction: column">
        ...
        <div class="modalBody" style="padding: 1rem">
          <div class="list-group">
            <div v-if="selectedServiceType === 'license'">
              <button type="button"
                class="list-group-item list-group-item-action d-flex justify-content-between align-items-center"
                aria-current="true" :class="{
                  active:
              ...
              <button type="button"
                class="list-group-item list-group-item-action d-flex justify-content-between align-items-center" :class="{
                  active: selectedSpecificService === 'New Driver License (Non-Professional)',
                }" @click="selectSpecificService('New Driver License (Non-Professional)')" style="margin-top: 0">
              ...
              <button type="button"
                class="list-group-item list-group-item-action d-flex justify-content-between align-items-center" :class="{
                  ...
                  selectSpecificService('Conductor License')
                  " style="margin-top: 0">
                Conductor’s License
                <span class="badge bg-primary rounded-pill">14</span>
              </button>
            </div>
            <div v-if="selectedServiceType === 'registration'">
              <button type="button"
                class="list-group-item list-group-item-action d-flex justify-content-between align-items-center"
                aria-current="true" :class="{
                  active:
            ...
            <div v-if="selectedServiceType === 'LETAS'">
              <button type="button"
                class="list-group-item list-group-item-action d-flex justify-content-between align-items-center"
                aria-current="true" :class="{
                  active:
              ...
              <button type="button"
                class="list-group-item list-group-item-action d-flex justify-content-between align-items-center" :class="{
                  active: selectedSpecificService === 'LETAS Fines and Penalties',
                }" @click="selectSpecificService('LETAS Fines and Penalties')" style="margin-top: 0">
              ...
              <button type="button"
                class="list-group-item list-group-item-action d-flex justify-content-between align-items-center" :class="{
                  active:
                    selectedSpecificService ===
                    'Encoding of Alarm on Driver License and Motor Vehicles in Relation to Orders Issued by Competent Courts or Quasi-Judicial Bodies',
                }" @click="
                  selectSpecificService('Encoding of Alarm on Driver License and Motor Vehicles in Relation to Orders Issued by Competent Courts or Quasi-Judicial Bodies')
                  " style="margin-top: 0">
